            ...
            <section class="panel">
                <header class="panel-heading tab-bg-dark-navy-blue">
                    <ul class="nav nav-tabs nav-justified ">
                        <li class="active">
                            <a href="#fa" data-toggle="tab">پارسی
                            </a>
                        </li>
                        <li class="">
                            <a href="#en" data-toggle="tab">english
                            </a>
                        </li>
                    </ul>
                </header>
                            ...
                            <aside class="profile-nav alt green-border">
                                <section class="panel">
                                    ...
                                    <ul class="nav nav-pills nav-stacked">
                                        ...
                                        <li><a data-toggle="modal" data-target="#Modal" data-remote="false"
                                               href="{{url('admin/auctions/canbid', $auction->id)}}"><i
                                                        class="icon-envelope-alt"></i>کاربرانی که میتوانند پیشنهاد قیمت دهند <span
                                                        class="label label-success pull-right r-activity">{{$auction->lotsCount}}</span></a>
                                        </li>
                                        <li>
                            ...
                            <aside class="profile-nav alt green-border">
                                <section class="panel">
                                    <div class="user-heading alt green-bg">
                                        ...
                                        <h1>{{ $auction->title['en'] }}</h1>
                                        <p>{{ $auction->description['en'] }}</p>
                                    </div>

                                    <ul class="nav nav-pills nav-stacked">
                                        <li><a href="javascript:;"><i class="icon-time"></i>Mail Inbox <span
                                                        class="label label-primary pull-right r-activity">19</span></a>
                                        </li>
                                        <li><a href="javascript:;"><i class="icon-calendar"></i>Recent Activity <span
                                                        class="label label-info pull-right r-activity">11</span></a>
                                        </li>
                                        <li><a href="javascript:;"><i
                                                        class="icon-bell-alt"></i>category {{$auction->category['category']['title']['en']}}
                                                <span class="label label-warning pull-right r-activity">03</span></a>
                                        </li>
                                        <li><a href="javascript:;"><i class="icon-envelope-alt"></i>Message <span
                                                        class="label label-success pull-right r-activity">10</span></a>
                                        </li>
                                    </ul>
