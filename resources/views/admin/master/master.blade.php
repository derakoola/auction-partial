                    ...
                    <ul class="dropdown-menu extended inbox">
                        ...
                        <li>
                            <a href="#">
                                    ...
                                    <span class="subject">
                                        <span class="from">{{Auth::user()->username }}</span>
...
<script src="{{ url('asset/admin/js/jquery-ui-1.9.2.custom.min.js') }}"></script>
...
<script src="{{ url('asset/admin/js/common-scripts.js') }}"></script>
